...
import { testLogin, testCrimes} from '../services/functionary.js';
...
export default function () {
    ...
    const res = testCrimes(baseUrl, headersBase, user.jwt);
    if(!res){
        console.error(`Error in testCrimes for user ${user.email}`);
    }else{
        console.log(`testCrimes for user ${user.email} passed`);
    }
