...
import { testLogin, testGetDependences} from '../services/functionary.js';
...
export default function () {
    ...
    const res = testGetDependences(baseUrl, headersBase, user.jwt);
    if(!res){
        console.error(`Error in testGetDependences for user ${user.email}`);
    }else{
        console.log(`testGetDependences for user ${user.email} passed`);
    }
