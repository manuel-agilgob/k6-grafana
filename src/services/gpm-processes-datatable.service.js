...
/**
 * Consulta el datatable de procesos (server-side).
 ...
 */
export function getProcessesDatatable(baseUrl, csrfToken, start = 0, length = 10, search = "") {
  ...
  return http.post(`${baseUrl}/processes/datatable`, payload, {
    headers: {
      "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
      Accept: "application/json, text/javascript, */*; q=0.01",
      "X-Requested-With": "XMLHttpRequest",
      Referer: `${baseUrl}/processes`,
    },
  });
}
